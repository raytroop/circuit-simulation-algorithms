...
for i in range(DeviceCount):
    ...
    if DevType[i]=='capacitor':
        ...
        if DevNode1[i] != '0' : STA_matrix[NumberOfNodes+i][Nodes.index(DevNode1[i])]=-DevValue[i]/deltaT
        if DevNode2[i] != '0' : STA_matrix[NumberOfNodes+i][Nodes.index(DevNode2[i])]=DevValue[i]/deltaT
    ...
    if DevType[i]=='inductor':
        STA_matrix[NumberOfNodes+i][NumberOfNodes+i]=1
        if DevNode1[i] != '0' : STA_matrix[NumberOfNodes+i][Nodes.index(DevNode1[i])]=-deltaT/DevValue[i]
        if DevNode2[i] != '0' : STA_matrix[NumberOfNodes+i][Nodes.index(DevNode2[i])]=deltaT/DevValue[i]
        if DevNode1[i] != '0' : STA_matrix[Nodes.index(DevNode1[i])][NumberOfNodes+i]=1
        if DevNode2[i] != '0' : STA_matrix[Nodes.index(DevNode2[i])][NumberOfNodes+i]=-1
